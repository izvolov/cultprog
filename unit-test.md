...
> **Примечание**
>
> Не следует также забывать, что код модульных тестов — это тоже код. Это значит, что другие
> программисты (не только автор) должны иметь возможность понять этот код и, при необходимости,
> исправить.
